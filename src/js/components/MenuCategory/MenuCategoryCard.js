...
export const MenuCategoryCard = (product) => {
  return `
    <div id="type${product.type}" class="flex flex-col bg-orange shadow-md shadow-black rounded-3xl md:rounded-none md:rounded-es-3xl md:rounded-ee-3xl p-3 cursor-pointer">
